...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.5\linewidth]{mctm_autocorrelation_original.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.62\linewidth]{mctm_2_states.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.62\linewidth]{mctm_3_states.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.47\linewidth]{respect_deadline_comparison.pdf}}
