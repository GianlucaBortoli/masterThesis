...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.75\linewidth]{mctm_2_states.png}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.75\linewidth]{mctm_3_states.png}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.7\linewidth]{respect_deadline_comparison.pdf}}
