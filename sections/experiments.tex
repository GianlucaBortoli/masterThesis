...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.4\linewidth]{mctm_1_state_new.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.75\linewidth]{mctm_2_states_new.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.75\linewidth]{mctm_3_states_new.pdf}}
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.65\linewidth]{respect_deadline_comparison.pdf}}
