...
%TODO cambierei le due frasi precedenti
Talking about the enterprise environment, most of the desktop pieces of software have its own GUI
%cambierei enterprise environment con embedded world, togliere desktop pieces, (most of the software..)
...
%web application -> high intensive graphical web application

The test application developed and extensively analyzed in this work is a 3D navigator.
%TODO analized e' molto volgare come parola -> occhio!
