...
giving deterministic and precictable response times, quantifying the worst-case
...
example is that nobody wants a segmentation fault in a car braking system while
it is being used.\\
%Sono un po' perplesso sull'esempio, non parlerei di segmentation fault, 
%ma più che altro di errore hardware di un sensore
