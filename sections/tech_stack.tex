...
%TODO credo che allows to sia sbagliato utilizzato in questo modo (devi metterci un nome dopo) 
...
To better understand how GPU comes into play inside the architechture of Google
...
\begin{figure}[!htb]
    \center{\includegraphics[width=0.8\linewidth]{chrome_gpu_architechture.png}}
